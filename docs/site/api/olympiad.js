...
const SNAPSHOT = {
  ...
  community: {
    ...
    issues: "https://github.com/ceedot-rock/great-agentic-olympiad/issues",
    contributing:
      "https://github.com/ceedot-rock/great-agentic-olympiad/blob/main/CONTRIBUTING.md",
    call: "Help build the world stage — PRs and issues welcome.",
  },
  site: `${SITE}/olympiad`,
