...
export const CATALOGS = [
  {
    ...
    entries: [
      ...
      { id: "pulsar-exception", name: "pulsar closed-embed exception", price: "$490/yr", note: "Pay $490/year to embed the free GPLv3 compressor in one closed product for one year. Not AWARE.", url: SITE + "/pay?sku=pulsar-exception", related: ["license", "pulsar"] },
      ...
      { id: "gc-day", name: "AWARE day", price: "$9", note: "Hosted lossless compressor for one day. Paid access, no source.", url: SITE + "/gc", related: ["aware"] },
      { id: "gc-month", name: "AWARE month", price: "$49/mo", note: "Hosted lossless compressor. 200 GB included, then 8¢/GB. Paid access, no source.", url: SITE + "/gc", related: ["aware"] },
      { id: "gc-year", name: "AWARE year", price: "$490/yr", note: "Hosted lossless compressor. 2,000 GB included, then 8¢/GB. Paid access, no source.", url: SITE + "/gc", related: ["aware", "pulsar"] },
      ...
      { id: "suite", name: "AWARE metered jobs", price: "2 GB/mo free, then 8¢/GB", note: "First 2 GB each month free. Then 8¢ per GB. Month plan includes 200 GB. Compare: /compare. Quote: POST /api/ppp-quote.", url: SITE + "/compare", related: ["aware", "rail"] },
      { id: "lab-pass", name: "Lab Pass", price: "$668/yr", note: "One year of Chamber + AWARE + TruGame for $668. Does not include Rider.", url: SITE + "/lab-pass", related: ["chamber", "aware"] },
      ...
      { id: "oss-support", name: "OSS support", price: "$199", note: "Help with an already-public GPLv3 library. Not a license to embed, and not AWARE.", url: SITE + "/pay?sku=oss-support", related: ["npm"] },
    ],
  },
  {
    id: "license",
    ...
    entries: [
      ...
      { id: "seat", name: "Hosted seat", note: "You buy the right to run AWARE, Chamber, Rider, or Lab Pass. You do not get the production engine.", url: SITE + "/licensing.json" },
  ...
  },
  {
    ...
    title: "AWARE",
    entries: [
      { id: "engine", name: "AWARE", note: "Hosted compressor. Files and live 4 KiB pipe, one seat. $9/day · $49/mo · $490/yr. Paid access, no source.", url: SITE + "/gc" },
      { id: "stream", name: "AWARE stream", note: "4 KiB ZERO+STORE pipe for agent logs / SIEM. Same AWARE seat.", url: SITE + "/trustream" },
      { id: "meter", name: "AWARE meter", note: "Billing: 6.9 GB / 3 h unpaid, then ~5¢/GB. Not a fifth product.", url: SITE + "/pps" },
    ],
  },
  {
    id: "pulsar",
    title: "pulsar",
    entries: [
      { id: "cousin", name: "Public compressor", note: "Free GPLv3 lossless compressor. Not AWARE. Beats gzip on Silesia. Loses to xz. $490/yr to embed closed.", url: "https://github.com/ceedot-rock/pulsar-best" },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: "spl-pay-per-suite", name: "spl-pay-per-suite", note: "Quote helper for metered AWARE jobs. Unpaid 6.9 GB / 3 h. No encoder.", url: "https://www.npmjs.com/package/spl-pay-per-suite" },
      ...
      { id: "tru8", name: "@cptasz13/tru8", note: "Zeros demo. 1 000 000 zeros → 8 bytes. Non-zero input is not free — buy AWARE.", url: "https://www.npmjs.com/package/@cptasz13/tru8" },
      { id: "shard-zip", name: "shard-zip", note: "Historical GPLv3 package. Not AWARE.", url: "https://www.npmjs.com/package/shard-zip" },
      { id: "shard-tsdb", name: "shard-tsdb", note: "Historical GPLv3 package. Not AWARE.", url: "https://www.npmjs.com/package/shard-tsdb" },
      { id: "pulsar", name: "pulsar 2.5.0", note: "Not npm. cargo/git GPLv3. Free to build; $490/yr to embed closed. Not AWARE.", url: SITE + "/pulsar" },
    ],
  },
  {
    id: "docs",
