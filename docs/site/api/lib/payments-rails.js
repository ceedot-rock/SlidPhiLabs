...
export const PRODUCT_CATALOG = {
  ...
  "pulsar-exception": {
    ...
    kind: "exception",
    list: true,
    blurb: "Written exception to embed pulsar in one closed-source product for one year. pulsar source stays GPLv3. Not Combined GC, not AWARE, not LBR1. $199 OSS support is help, not this grant.",
  },
  "lab-pass": {
