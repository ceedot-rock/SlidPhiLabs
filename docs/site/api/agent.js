...
const STANDING = [
  ...
  { sku: "gc-day", name: "AWARE · 24-hour compressor seat", usd: "9", kind: "gc", blurb: "Hosted lossless compressor. 24 hours. You do not get the encoder." },
  { sku: "gc-month", name: "AWARE · monthly compressor seat", usd: "49", kind: "gc", blurb: "Hosted lossless compressor. Calendar month. 200 GB included, then 8¢/GB." },
  { sku: "gc-year", name: "AWARE · annual compressor seat", usd: "490", kind: "gc", blurb: "Hosted lossless compressor. Calendar year. 2,000 GB included, then 8¢/GB." },
...
export default async function handler(req, res) {
  ...
  const body = {
    ...
    one_liner:
      "CuNi $0. Chamber $9/mo · $99/yr. AWARE $9/$49/$490. Rider $79/mo · $790/yr. First 2 GB/mo free, then 8¢/GB.",
