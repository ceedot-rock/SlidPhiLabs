...
const STANDING = [
  ...
  { sku: "trugame-year", name: "TruGame · Year", usd: "79", kind: "engine", blurb: "Engine seat. Rent desk retired." },
...
export default async function handler(req, res) {
  ...
  const body = {
    ...
    suite_pricing: {
      ...
      try_gate: "retired",
      note: "Suite unpaid cap 6.9 GB and 3 hours, then ~5¢/GB. Combined GC measured, not a general #1.",
    },
    university: {
