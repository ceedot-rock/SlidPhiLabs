...
const STANDING = [
  { sku: "cuni-studio", name: "CuNi Studio", usd: "0", kind: "exactness", blurb: "Write once. 144 languages. Same stdout or refuse. Native seats: py/go/js/ts/c/cpp/rs." },
  ...
  { sku: "gc-month", name: "PCC Pro · monthly", usd: "49", kind: "pcc", blurb: "Hosted lossless compression. 200 GB this month, then 8¢/GB." },
  { sku: "suite", name: "PCC usage", usd: "meter", kind: "pcc", blurb: "First 2 GB each month free, then 8¢/GB." },
  { sku: "lab-check", name: "CuNi check", usd: "0.10", kind: "cuni", blurb: "One exactness check." },
  { sku: "lab-translate", name: "CuNi Bank paste", usd: "0.10", kind: "cuni", blurb: "One Bank paste." },
  { sku: "lab-squeeze", name: "PCCX squeeze", usd: "0.10", kind: "pccx", blurb: "One squeeze." },
...
export default async function handler(req, res) {
  ...
  const body = {
    ...
    retired: ["trugame-rent-week", "trugame-month", "trugame-year", "zrw-n00b", "zrw-pro", "zrw-l33t"],
    parked: ["trugame-month", "trugame-year"],
