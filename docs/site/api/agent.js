...
const STANDING = [
  ...
  { sku: "gc-day", name: "AWARE · Day", usd: "9", kind: "gc", blurb: "Adaptive Waveform Archive Restore Engine. 24 hours." },
  { sku: "gc-month", name: "AWARE · Month", usd: "49", kind: "gc", blurb: "Adaptive Waveform Archive Restore Engine. Calendar month." },
  { sku: "gc-year", name: "AWARE · Year", usd: "490", kind: "gc", blurb: "Adaptive Waveform Archive Restore Engine. Year seat." },
  ...
  { sku: "gate-day", name: "Gate · Day", usd: "29", kind: "gate", blurb: "Mixed-file lossless picker." },
  { sku: "gate-month", name: "Gate · Month", usd: "89", kind: "gate", blurb: "Mixed-file lossless picker." },
  { sku: "gate-year", name: "Gate · Year", usd: "790", kind: "gate", blurb: "Mixed-file lossless picker." },
  { sku: "lab-pass", name: "Lab Pass · Year", usd: "1088", kind: "seat", blurb: "Chamber + TRU8 + Gate + TruGame, 365 days." },
  { sku: "trugame-month", name: "TruGame · Month", usd: "12", kind: "engine", blurb: "Engine seat." },
  { sku: "trugame-year", name: "TruGame · Year", usd: "79", kind: "engine", blurb: "Engine seat." },
