...
const STANDING = [
  ...
  { sku: "gc-year", name: "AWARE · annual compressor seat", usd: "490", kind: "gc", blurb: "Hosted lossless compressor. Calendar year. TRU8/Gate/ZRW are names inside this stack." },
...
export default async function handler(req, res) {
  ...
  const body = {
    ...
    one_liner:
      "CuNi $0. Chamber $9/mo · $99/yr. AWARE $9/$49/$490. Rider Labs team seat $79/mo · $790/yr. Suite 6.9 GB / 3 h then ~5¢/GB.",
    ...
    codec: {
        ...
        public: "AWARE is the hosted compression product; TRU8 is a public demonstration package. Historical engines remain licensed lab work.",
