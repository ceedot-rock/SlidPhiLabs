...
const STANDING = [
  ...
  { sku: "cuni-exception", name: "CuNi · closed-app exception", usd: "490", kind: "exception", blurb: "One closed product, one year. Not the compressor." },
  { sku: "chamber-day", name: "Chamber · 24-hour seat", usd: "9", kind: "chamber", blurb: "Two-key JSON seal. 24 hours. Not a compressor." },
  { sku: "chamber-month", name: "Chamber · monthly seat", usd: "49", kind: "chamber", blurb: "Two-key JSON seal. Calendar month." },
  { sku: "chamber-year", name: "Chamber · annual seat", usd: "490", kind: "chamber", blurb: "Two-key JSON seal. Calendar year." },
  { sku: "gc-day", name: "AWARE · 24-hour compressor seat", usd: "9", kind: "gc", blurb: "Hosted lossless compressor. 24 hours. Engine stays in the lab." },
  { sku: "gc-month", name: "AWARE · monthly compressor seat", usd: "49", kind: "gc", blurb: "Hosted lossless compressor. Calendar month." },
  { sku: "gc-year", name: "AWARE · annual compressor seat", usd: "490", kind: "gc", blurb: "Hosted lossless compressor. Calendar year." },
  ...
  { sku: "lab-pass", name: "Lab Pass · annual", usd: "1088", kind: "seat", blurb: "Chamber + AWARE + TruGame, 365 days. Not Rider." },
...
export default async function handler(req, res) {
  ...
  const body = {
    ...
    rails: {
      ...
      mcp_credits: "https://agentrider.fly.dev purchase_credits $1=100 AGC",
    },
    ...
    rails: {
      universal: {
        ...
        policy: "Humans: Stripe card checkout. Teams: invoice. Agents: x402. Claim Access after payment.",
      },
      human: {
