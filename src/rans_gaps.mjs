...
const MSG = "rans_gaps is proprietary (Slid Phi Labs). Public repo ships stubs only. Free first 100 GB → https://www.slidphilabs.com/pps  |  Access → https://www.slidphilabs.com/access";
